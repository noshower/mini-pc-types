...
declare namespace tinyapp {
   ...
   */
  interface IBaseEvent<Dataset = Readonly<Record<string, any>>> {
  ...
  interface ICustomEvent<Detail = Readonly<Record<string, any>>, Dataset = Readonly<Record<string, any>>> extends IBaseEvent<Dataset> {
    /**
